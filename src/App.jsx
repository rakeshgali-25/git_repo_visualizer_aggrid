...
export default function App() {
  ...
  const columnDefs = [
    {
      ...
      // flex: 1.4,
      // cellRenderer: (p) =>
      //   `<a style="color:#2563eb;font-weight:600" href="${p.data.html_url}" target="_blank">${p.data.name}</a>`
    },
  ...
  // fetch all repos (handles pagination + 404 errors)
  ...
  return (
    <div className="app-container">
      ...
      <div className="header">
        ...
        {/* <p className="subtitle">Fast • Modern • Clean UI</p> */}
      </div>
